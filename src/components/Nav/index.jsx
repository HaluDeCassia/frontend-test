...
const Nav = () => {
  ...
  // NOTE: whenever the screen is resized, it will be necessary to load the page so that the menu has its default behavior
  React.useEffect(() => toggleMenu(window.innerWidth < 1024 ? false : true), [menu]);
