        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="flex flex-col w-full md:w-1/4 px-3">
            ...
            <div className="relative text-gray-600 focus-within:text-gray-400">
              ...
              <input id="origin" type="text" name="origin" className="py-3 w-full text-sm bg-gray-100 text-gray-700 border-2 border-gray-400 rounded pl-10 focus:outline-none focus:bg-white focus:text-gray-900" placeholder="Ex.: São Paulo" />
            </div>
          </div>
          <div className="w-full md:w-1/4 px-3">
            ...
            <div className="relative text-gray-600 focus-within:text-gray-400">
              ...
              <input id="destiny" type="text" name="destiny" className="py-3 w-full text-sm bg-gray-100 text-gray-700 border-2 border-gray-400 rounded pl-10 focus:outline-none focus:bg-white focus:text-gray-900" placeholder="Ex.: Rio de Janeiro" />
            </div>
          </div>
          <div className="w-full md:w-1/4 px-3">
            ...
            <div className="relative text-gray-600 focus-within:text-gray-400">
              ...
              <input id="date" type="text" name="date" className="py-3 w-full text-sm bg-gray-100 text-gray-700 border-2 border-gray-400 rounded pl-10 focus:outline-none focus:bg-white focus:text-gray-900" placeholder="Ex.: Sábado 14/4 - Quinta 18/4" />
            </div>
          </div>
          <div className="w-full md:w-1/4 px-3">
            ...
            <div htmlFor="people" className="relative text-gray-600 focus-within:text-gray-400">
              ...
              <input id="people" type="text" name="people" className="py-3 w-full text-sm bg-gray-100 text-gray-700 border-2 border-gray-400 rounded pl-10 focus:outline-none focus:bg-white focus:text-gray-900" placeholder="Ex.: 1 pessoa" />
            </div>
          </div>
        </div>
      </form>
